...
export default function Shoes() {
  ...
  const filteredProducts = products.filter(product => {
    ...
    return catName.toLowerCase().includes("shoe") || catName.includes("حذاء") || catName.includes("احذ");
  });
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-8">
      <div className="mb-8 border-b pb-4">
        <h1 className="text-3xl font-black text-slate-800">الأحذية</h1>
        <p className="text-muted-foreground mt-2">تسوق أحدث صيحات الأحذية المريحة والأنيقة</p>
      </div>
