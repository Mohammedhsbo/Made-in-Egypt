...
export default function Clothes() {
  ...
  const filteredProducts = products.filter(product =>
    product.subcategory?.some(sub => sub.name === "Women's Clothing")
  );
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-8">
      <div className="mb-8 border-b pb-4">
        <h1 className="text-3xl font-black text-slate-800">الملابس</h1>
        <p className="text-muted-foreground mt-2">تصفح أحدث الأزياء والملابس بأفضل الأسعار</p>
      </div>
